...
class TriangleShape(BaseShape):
    ...
    def intersect(self, ro, rd, t0, t1):
        C, H, W = ro.shape[:3]
        p0 = F.broadcast_to(self.points[0].reshape((3, 1, 1)), (3, H, W))
        p1 = F.broadcast_to(self.points[1].reshape((3, 1, 1)), (3, H, W))
        p2 = F.broadcast_to(self.points[2].reshape((3, 1, 1)), (3, H, W))
